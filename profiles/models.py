...
class UserProfile(models.Model):
    ...
    Attributes:
        ...
        default_street_address2 (CharField): Secondary street address (optional).
        ...
        default_country (CountryField): Country selection using django-countries.
...
def create_or_update_user_profile(sender, instance, created, **kwargs):
    ...
    - If an existing user is updated, their profile is saved to reflect changes.
    """
    if created:
