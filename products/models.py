...
class ProductReview(models.Model):
    ...
    Each review includes a title, detailed feedback, a rating, and the date it was created.  
    ...
    Attributes:  
        ...
        rating (PositiveIntegerField): A rating given to the product (e.g., from 1 to 5).  
    ...
    product = models.ForeignKey(Product, related_name='product_reviews_from_products', on_delete=models.CASCADE)  
