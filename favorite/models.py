...
class Favorite(models.Model):
    ...
    This model establishes a many-to-many relationship between users \
    and products,
    allowing users to mark products as favorites. Each user can favorite a \
    product only once.
    ...
    Meta:
        unique_together: Ensures that a user cannot favorite the same \
